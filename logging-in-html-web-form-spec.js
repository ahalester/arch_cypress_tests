...
describe('Logging In - HTML Web Form', function () {
  ...
  const username = 'gregg+tester@archemedx.com'
  ...
  context('Unauthorized', function () {
    ...
    it('is redirected using cy.request', function () {
      ...
      cy.request({
        url: 'https://kyber.arche.services/curriculum/4567b1f1-07f0-4764-8d4a-351d624e5445/activity/2b6b9266-079d-4f14-b169-0c0360d1dc08',
  ...
  context('HTML form submission', function () {
    ...
    it('displays errors on login', function () {
      ...
      cy.get('input[name=username]').type('gregg+tester@archemedx.com')
    ...
    it('redirects to /dashboard on success', function () {
      ...
      cy.get('h1').should('contain', 'gregg+tester@archemedx.com')
